...
content = open('src/components/SummaryDashboard.jsx').read()
...
"""
content = content.replace("import React from 'react';\nimport { LayoutDashboard, Wallet, ArrowRightLeft } from 'lucide-react';", new_imports)
...
content = content.replace("  const totalAllocationsUSD = funds.transactions.filter", chart_logic + "\n  const totalAllocationsUSD = funds.transactions.filter")
...
open('src/components/SummaryDashboard.jsx', 'w').write(content)
